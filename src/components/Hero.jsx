...
export default function Hero() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br space-y-5 
                ...
                <div className="space-y-8 text-center lg:text-left">
                    <div className="relative group">
                        <div className="relative w-48 h-48 mx-auto lg:mx-0">
                            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-indigo-500 to-teal-500 animate-pulse group-hover:animate-none transition-all duration-500"
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-2 text-gray-600 dark:text-gray-400">
                            <CodeIcon size={16} className="w-4 h-4 text-indigo-500 dark:text-indigo-400" />
                    ...
                    <div className="flex gap-4 justify-center lg:justify-start">
                        {[
                            ...
                            { icon: Facebook, href: "https://www.facebook.com/buletboy.mekat", label: "Facebook" },
