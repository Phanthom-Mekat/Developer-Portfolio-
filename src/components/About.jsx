    ...
    const highlights = [
        {
            ...
            description: "Passionate about crafting responsive and interactive UIs using React.js, Tailwind CSS, and modern frameworks. Currently working on Platemate, focusing on creating efficient user experiences.",
        ...
        },
        {
            ...
            description: "CCNA certified in networking and IP addressing. Active participant in tech events, winning the Robo Race at IEEE DAY 2022. Constantly exploring AI, data science, and machine learning.",
        ...
        },
        {
            icon: HeartIcon,
            title: "Beyond Coding",
            description: "When not programming, I enjoy playing sports, staying active, and listening to music. I believe in maintaining a healthy work-life balance while staying updated with the latest tech trends.",
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed relative dark:text-gray-600">
                            I'm a Computer Science and Engineering student passionate about full-stack web development, 
