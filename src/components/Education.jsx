    ...
    const educationDetails = [
        {
            ...
            description: "Completed Higher Secondary Education with a strong academic foundation, developing critical thinking and analytical skills.",
            iconColor: "text-blue-500",
            gradientFrom: "from-blue-500/10",
            gradientTo: "to-cyan-500/10",
            achievements: [
                "Top 5% in Science Stream",
